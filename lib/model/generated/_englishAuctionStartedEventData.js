...
exports.EnglishAuctionStartedEventData = void 0;
const assert_1 = __importDefault(require("assert"));
const marshal = __importStar(require("./marshal"));
const _contentActor_1 = require("./_contentActor");
const _nftOwner_1 = require("./_nftOwner");
class EnglishAuctionStartedEventData {
    constructor(props, json) {
        this.isTypeOf = 'EnglishAuctionStartedEventData';
...
exports.EnglishAuctionStartedEventData = EnglishAuctionStartedEventData;
//# sourceMappingURL=_englishAuctionStartedEventData.js.map