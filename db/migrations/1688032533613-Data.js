module.exports = class Data1688032533613 {
    name = 'Data1688032533613'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "on_chain_notification" ("id" character varying NOT NULL, "account_id" character varying, "event_id" character varying, "in_app_read" boolean NOT NULL, "mail_sent" boolean NOT NULL, "type" jsonb NOT NULL, CONSTRAINT "PK_a143f8be1fce876aa2a396aee53" PRIMARY KEY ("id"))`)
