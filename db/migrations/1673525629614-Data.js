module.exports = class Data1673525629614 {
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "banned_member" ("id" character varying NOT NULL, "member_id" character varying, "channel_id" character varying, CONSTRAINT "PK_ebdf9a9c6d88f1116a5f2d0815d" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_ed36c6c26bf5410796c2fc21f7" ON "banned_member" ("channel_id") `)
    await db.query(`CREATE UNIQUE INDEX "IDX_f29ff095bdb945975deca021ad" ON "banned_member" ("member_id", "channel_id") `)
    ...
    await db.query(`CREATE TABLE "comment" ("id" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "text" text NOT NULL, "status" character varying(9) NOT NULL, "reactions_count_by_reaction_id" jsonb, "replies_count" integer NOT NULL, "reactions_count" integer NOT NULL, "reactions_and_replies_count" integer NOT NULL, "is_edited" boolean NOT NULL, "author_id" character varying, "video_id" character varying, "parent_comment_id" character varying, CONSTRAINT "PK_0b0e4bbc8415ec426f87f3a88e2" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "video" ("id" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "title" text, "description" text, "duration" integer, "language" text, "has_marketing" boolean, "published_before_joystream" TIMESTAMP WITH TIME ZONE, "is_public" boolean, "is_censored" boolean NOT NULL, "is_explicit" boolean, "video_state_bloat_bond" numeric NOT NULL, "created_in_block" integer NOT NULL, "is_comment_section_enabled" boolean NOT NULL, "comments_count" integer NOT NULL, "is_reaction_feature_enabled" boolean NOT NULL, "reactions_count_by_reaction_id" jsonb, "reactions_count" integer NOT NULL, "views_num" integer NOT NULL, "channel_id" character varying, "category_id" character varying, "thumbnail_photo_id" character varying, "license_id" character varying, "media_id" character varying, "pinned_comment_id" character varying, CONSTRAINT "PK_1a2f3856250765d72e7e1636c8e" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "video_view_event" ("id" SERIAL NOT NULL, "ip" character varying NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "video_id" character varying, CONSTRAINT "PK_2efd85597a6a7a704fc4d0f7701" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "report" ("id" SERIAL NOT NULL, "ip" character varying NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "rationale" character varying NOT NULL, "channel_id" character varying NOT NULL, "video_id" character varying, CONSTRAINT "PK_99e4d0bea58cba73c57f935a546" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "gateway_config" ("id" character varying NOT NULL, "value" boolean NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_db1fa5a857fb6292eee4c493e6f" PRIMARY KEY ("id"))`)
    ...
    await db.query(`ALTER TABLE "banned_member" ADD CONSTRAINT "FK_b94ea874da235d9b6fbc35cf58e" FOREIGN KEY ("member_id") REFERENCES "membership"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    await db.query(`ALTER TABLE "banned_member" ADD CONSTRAINT "FK_ed36c6c26bf5410796c2fc21f74" FOREIGN KEY ("channel_id") REFERENCES "channel"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    ...
    await db.query(`ALTER TABLE "channel_follow" ADD CONSTRAINT "FK_9bc0651dda94437ec18764a2601" FOREIGN KEY ("channel_id") REFERENCES "channel"("id") ON DELETE CASCADE ON UPDATE NO ACTION`)
    await db.query(`ALTER TABLE "video_view_event" ADD CONSTRAINT "FK_2e29fba63e12a2b1818e0782d78" FOREIGN KEY ("video_id") REFERENCES "video"("id") ON DELETE CASCADE ON UPDATE NO ACTION`)
    await db.query(`ALTER TABLE "report" ADD CONSTRAINT "FK_893057921f4b5cc37a0ef366845" FOREIGN KEY ("channel_id") REFERENCES "channel"("id") ON DELETE CASCADE ON UPDATE NO ACTION`)
    await db.query(`ALTER TABLE "report" ADD CONSTRAINT "FK_f732b6f82095a935db68c9491fc" FOREIGN KEY ("video_id") REFERENCES "video"("id") ON DELETE CASCADE ON UPDATE NO ACTION`)
  }
  ...
  async down(db) {
    ...
    await db.query(`ALTER TABLE "report" DROP CONSTRAINT "FK_893057921f4b5cc37a0ef366845"`)
    await db.query(`ALTER TABLE "report" DROP CONSTRAINT "FK_f732b6f82095a935db68c9491fc"`)
  }
}
