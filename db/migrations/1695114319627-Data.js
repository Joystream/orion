module.exports = class Data1695114319627 {
    name = 'Data1695114319627'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "member_recipient" ("id" character varying NOT NULL, "notification_id" character varying, "membership_id" character varying, "data" jsonb NOT NULL, CONSTRAINT "PK_bdd1cf626b49e95970745de2420" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_678ddcd9f177366e1c556d46dc" ON "member_recipient" ("notification_id") `)
        await db.query(`CREATE INDEX "IDX_493c845179218774a405fbadea" ON "member_recipient" ("membership_id") `)
        await db.query(`CREATE TABLE "notification" ("id" character varying NOT NULL, "account_id" character varying, "event_id" character varying, "status" jsonb NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_705b6c7cdf9b2c2ff7ac7872cb7" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "creator_recipient" ("id" character varying NOT NULL, "notification_id" character varying, "channel_id" character varying, "data" jsonb NOT NULL, CONSTRAINT "PK_61d1abb04cc37763b8371c45433" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_a8371bd4bc3d22a5cf19492635" ON "creator_recipient" ("notification_id") `)
        await db.query(`CREATE INDEX "IDX_deca4643035be643fe6b266672" ON "creator_recipient" ("channel_id") `)
        await db.query(`CREATE TABLE "channel" ("id" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "owner_member_id" character varying, "title" text, "description" text, "cover_photo_id" character varying, "avatar_photo_id" character varying, "is_public" boolean, "is_censored" boolean NOT NULL, "is_excluded" boolean NOT NULL, "language" text, "created_in_block" integer NOT NULL, "reward_account" text NOT NULL, "channel_state_bloat_bond" numeric NOT NULL, "follows_num" integer NOT NULL, "video_views_num" integer NOT NULL, "entry_app_id" character varying, "total_videos_created" integer NOT NULL, "cumulative_reward_claimed" numeric, "ypp_status" jsonb NOT NULL, CONSTRAINT "PK_590f33ee6ee7d76437acf362e39" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "channel_verification" ("id" character varying NOT NULL, "channel_id" character varying, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_0a61c78b114ed3e92300e09afaa" PRIMARY KEY ("id"))`)
        ...
        await db.query(`ALTER TABLE "member_recipient" ADD CONSTRAINT "FK_678ddcd9f177366e1c556d46dcf" FOREIGN KEY ("notification_id") REFERENCES "notification"("id") ON DELETE NO ACTION ON UPDATE NO ACTION DEFERRABLE INITIALLY DEFERRED`)
        await db.query(`ALTER TABLE "member_recipient" ADD CONSTRAINT "FK_493c845179218774a405fbadea8" FOREIGN KEY ("membership_id") REFERENCES "membership"("id") ON DELETE NO ACTION ON UPDATE NO ACTION DEFERRABLE INITIALLY DEFERRED`)
        await db.query(`ALTER TABLE "notification" ADD CONSTRAINT "FK_6bfa96ab97f1a09d73091294efc" FOREIGN KEY ("account_id") REFERENCES "account"("id") ON DELETE NO ACTION ON UPDATE NO ACTION DEFERRABLE INITIALLY DEFERRED`)
        ...
        await db.query(`ALTER TABLE "creator_recipient" ADD CONSTRAINT "FK_a8371bd4bc3d22a5cf194926357" FOREIGN KEY ("notification_id") REFERENCES "notification"("id") ON DELETE NO ACTION ON UPDATE NO ACTION DEFERRABLE INITIALLY DEFERRED`)
        await db.query(`ALTER TABLE "creator_recipient" ADD CONSTRAINT "FK_deca4643035be643fe6b266672e" FOREIGN KEY ("channel_id") REFERENCES "channel"("id") ON DELETE NO ACTION ON UPDATE NO ACTION DEFERRABLE INITIALLY DEFERRED`)
        ...
        await db.query(`ALTER TABLE "notification_in_app_delivery" ADD CONSTRAINT "FK_2a997e449bbd54d6e515b990968" FOREIGN KEY ("notification_id") REFERENCES "notification"("id") ON DELETE NO ACTION ON UPDATE NO ACTION DEFERRABLE INITIALLY DEFERRED`)
    ...
    async down(db) {
        ...
        await db.query(`DROP TABLE "member_recipient"`)
        await db.query(`DROP INDEX "public"."IDX_678ddcd9f177366e1c556d46dc"`)
        await db.query(`DROP INDEX "public"."IDX_493c845179218774a405fbadea"`)
        ...
        await db.query(`DROP TABLE "creator_recipient"`)
        await db.query(`DROP INDEX "public"."IDX_a8371bd4bc3d22a5cf19492635"`)
        await db.query(`DROP INDEX "public"."IDX_deca4643035be643fe6b266672"`)
        ...
        await db.query(`DROP TABLE "notification_in_app_delivery"`)
        await db.query(`DROP INDEX "public"."IDX_2a997e449bbd54d6e515b99096"`)
        ...
        await db.query(`DROP TABLE "channel_verification"`)
        ...
        await db.query(`ALTER TABLE "member_recipient" DROP CONSTRAINT "FK_678ddcd9f177366e1c556d46dcf"`)
        await db.query(`ALTER TABLE "member_recipient" DROP CONSTRAINT "FK_493c845179218774a405fbadea8"`)
        ...
        await db.query(`ALTER TABLE "creator_recipient" DROP CONSTRAINT "FK_a8371bd4bc3d22a5cf194926357"`)
        await db.query(`ALTER TABLE "creator_recipient" DROP CONSTRAINT "FK_deca4643035be643fe6b266672e"`)
        ...
        await db.query(`ALTER TABLE "notification_in_app_delivery" DROP CONSTRAINT "FK_2a997e449bbd54d6e515b990968"`)
