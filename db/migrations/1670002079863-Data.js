module.exports = class Data1670002079863 {
  name = 'Data1670002079863'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "storage_bucket_operator_metadata" ("id" character varying NOT NULL, "node_endpoint" text, "node_location" jsonb, "extra" text, "storage_bucket_id" character varying NOT NULL, CONSTRAINT "REL_7beffc9530b3f307bc1169cb52" UNIQUE ("storage_bucket_id"), CONSTRAINT "PK_9846a397400ae1a39b21fbd02d4" PRIMARY KEY ("id"))`)
    await db.query(`CREATE UNIQUE INDEX "IDX_7beffc9530b3f307bc1169cb52" ON "storage_bucket_operator_metadata" ("storage_bucket_id") `)
    ...
    await db.query(`CREATE TABLE "distribution_bucket_family_metadata" ("id" character varying NOT NULL, "region" text, "description" text, "areas" jsonb, "latency_test_targets" text array, "family_id" character varying NOT NULL, CONSTRAINT "REL_dd93ca0ea24f3e7a02f11c4c14" UNIQUE ("family_id"), CONSTRAINT "PK_df7a270835bb313d3ef17bdee2f" PRIMARY KEY ("id"))`)
    await db.query(`CREATE UNIQUE INDEX "IDX_dd93ca0ea24f3e7a02f11c4c14" ON "distribution_bucket_family_metadata" ("family_id") `)
    ...
    await db.query(`CREATE TABLE "distribution_bucket_operator_metadata" ("id" character varying NOT NULL, "node_endpoint" text, "node_location" jsonb, "extra" text, "distirbution_bucket_operator_id" character varying NOT NULL, CONSTRAINT "REL_69ec9bdc975b95f7dff94a7106" UNIQUE ("distirbution_bucket_operator_id"), CONSTRAINT "PK_9bbecaa12f30e3826922688274f" PRIMARY KEY ("id"))`)
    await db.query(`CREATE UNIQUE INDEX "IDX_69ec9bdc975b95f7dff94a7106" ON "distribution_bucket_operator_metadata" ("distirbution_bucket_operator_id") `)
    await db.query(`CREATE TABLE "distribution_bucket_operator" ("id" character varying NOT NULL, "worker_id" integer NOT NULL, "status" character varying(7) NOT NULL, "distribution_bucket_id" character varying, CONSTRAINT "PK_03b87e6e972f414bab94c142285" PRIMARY KEY ("id"))`)
    ...
    await db.query(`ALTER TABLE "storage_bucket_operator_metadata" ADD CONSTRAINT "FK_7beffc9530b3f307bc1169cb524" FOREIGN KEY ("storage_bucket_id") REFERENCES "storage_bucket"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    ...
    await db.query(`ALTER TABLE "distribution_bucket_family_metadata" ADD CONSTRAINT "FK_dd93ca0ea24f3e7a02f11c4c149" FOREIGN KEY ("family_id") REFERENCES "distribution_bucket_family"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    await db.query(`ALTER TABLE "distribution_bucket_operator_metadata" ADD CONSTRAINT "FK_69ec9bdc975b95f7dff94a71069" FOREIGN KEY ("distirbution_bucket_operator_id") REFERENCES "distribution_bucket_operator"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
