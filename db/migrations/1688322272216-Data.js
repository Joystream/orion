module.exports = class Data1688322272216 {
    name = 'Data1688322272216'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "nft_featuring_request" ("id" character varying NOT NULL, "user_id" character varying, "nft_id" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "rationale" text NOT NULL, CONSTRAINT "PK_d0b1ccb74336b30b9575387d328" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "runtime_notification_processed" ("id" character varying NOT NULL, "notification_id" text NOT NULL, "mail_sent" boolean NOT NULL, "in_app_read" boolean NOT NULL, CONSTRAINT "PK_a3f7d19f7ea5be9d194da576b31" PRIMARY KEY ("id"))`)
        await db.query(`CREATE TABLE "runtime_notification" ("id" character varying NOT NULL, "account_id" character varying, "event_id" character varying, "type" jsonb NOT NULL, "notification_processed_id" character varying, CONSTRAINT "PK_386ebd5073dfbf98526a4f73218" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE INDEX "IDX_15715362b1e3d30b2cb19681a0" ON "runtime_notification" ("notification_processed_id") `)
        ...
        await db.query(`CREATE TABLE "off_chain_notification" ("id" character varying NOT NULL, "account_id" character varying, "data" jsonb NOT NULL, "in_app_read" boolean NOT NULL, "mail_sent" boolean NOT NULL, "type" jsonb NOT NULL, CONSTRAINT "PK_079caa028b5524d617d5d6373a8" PRIMARY KEY ("id"))`)
        ...
        await db.query(`ALTER TABLE "runtime_notification" ADD CONSTRAINT "FK_2c5b0cbfabbb47fc390f5b15746" FOREIGN KEY ("account_id") REFERENCES "account"("id") ON DELETE NO ACTION ON UPDATE NO ACTION DEFERRABLE INITIALLY DEFERRED`)
        await db.query(`ALTER TABLE "runtime_notification" ADD CONSTRAINT "FK_e1fbf907648973272e0b2d73605" FOREIGN KEY ("event_id") REFERENCES "event"("id") ON DELETE NO ACTION ON UPDATE NO ACTION DEFERRABLE INITIALLY DEFERRED`)
        await db.query(`ALTER TABLE "runtime_notification" ADD CONSTRAINT "FK_15715362b1e3d30b2cb19681a02" FOREIGN KEY ("notification_processed_id") REFERENCES "runtime_notification_processed"("id") ON DELETE NO ACTION ON UPDATE NO ACTION DEFERRABLE INITIALLY DEFERRED`)
    ...
    async down(db) {
        ...
        await db.query(`DROP TABLE "runtime_notification_processed"`)
        await db.query(`DROP TABLE "runtime_notification"`)
        await db.query(`DROP INDEX "public"."IDX_2c5b0cbfabbb47fc390f5b1574"`)
        await db.query(`DROP INDEX "public"."IDX_e1fbf907648973272e0b2d7360"`)
        await db.query(`DROP INDEX "public"."IDX_15715362b1e3d30b2cb19681a0"`)
        ...
        await db.query(`DROP TABLE "off_chain_notification"`)
        ...
        await db.query(`ALTER TABLE "runtime_notification" DROP CONSTRAINT "FK_2c5b0cbfabbb47fc390f5b15746"`)
        await db.query(`ALTER TABLE "runtime_notification" DROP CONSTRAINT "FK_e1fbf907648973272e0b2d73605"`)
        await db.query(`ALTER TABLE "runtime_notification" DROP CONSTRAINT "FK_15715362b1e3d30b2cb19681a02"`)
