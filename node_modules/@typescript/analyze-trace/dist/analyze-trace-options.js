...
exports.pushCommandLineOptions = exports.checkCommandLineOptions = exports.commandLineOptions = void 0;
...
function checkCommandLineOptions(argv) {
    if (argv.forceMillis < argv.skipMillis) {
        throw new Error("forceMillis cannot be less than skipMillis");
    }
    return true;
}
exports.checkCommandLineOptions = checkCommandLineOptions;
function pushCommandLineOptions(array, argv) {
    array.push("--force-millis", `${argv.forceMillis}`, "--skip-millis", `${argv.skipMillis}`, argv.expandTypes ? "--expand-types" : "--no-expand-types", argv.color ? "--color" : "--no-color", argv.json ? "--json" : "--no-json");
}
exports.pushCommandLineOptions = pushCommandLineOptions;
//# sourceMappingURL=analyze-trace-options.js.map