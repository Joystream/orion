 ...
 */
export declare type SpecId = string;
...
export declare type SubstrateEvent = SubstrateInitializationEvent | SubstrateApplyExtrinsicEvent | SubstrateFinalizationEvent;
