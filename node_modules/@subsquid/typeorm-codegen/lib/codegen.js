                    ...
                    case 'scalar':
                        if (key === 'id') {
                            ...
                            switch (prop.type.name) {
                                case 'BigInt':
                                    imports.useMarshal();
                                    out.line(`@Column_("${getDbType(prop.type.name)}", {transformer: marshal.bigintTransformer, nullable: ${prop.nullable}})`);
                                    break;
                                case 'BigDecimal':
                                    imports.useMarshal();
                                    out.line(`@Column_("${getDbType(prop.type.name)}", {transformer: marshal.bigdecimalTransformer, nullable: ${prop.nullable}})`);
                                    break;
                                case 'Float':
                                    imports.useMarshal();
                                    out.line(`@Column_("${getDbType(prop.type.name)}", {transformer: marshal.floatTransformer, nullable: ${prop.nullable}})`);
                                    break;
                                default:
                    ...
                    case 'list':
                        switch (prop.type.item.type.kind) {
                            case 'scalar': {
                                ...
                                out.line(`@Column_("${getDbType(scalar)}", {array: true, nullable: ${prop.nullable}})`);
                                break;
                            }
                            case 'enum':
