...
export declare type Type = PrimitiveType | CompactType | SequenceType | BitSequenceType | ArrayType | TupleType | OptionType | CompositeType | VariantType | DoNotConstructType;
export declare type TypeRegistry = Type[];
