...
export function setNotificationPreferences(account: Account, notificationPreferences: NotificationPreferences) {
        account.commentCreatedInAppNotificationEnabled = notificationPreferences.commentCreatedInAppNotificationEnabled
        account.commentCreatedMailNotificationEnabled = notificationPreferences.commentCreatedMailNotificationEnabled
        ...
        account.nftIssuedInAppNotificationEnabled = notificationPreferences.nftIssuedInAppNotificationEnabled
        account.auctionBidMadeInAppNotificationEnabled = notificationPreferences.auctionBidMadeInAppNotificationEnabled
        account.auctionBidCanceledInAppNotificationEnabled =
          notificationPreferences.auctionBidCanceledInAppNotificationEnabled
        account.auctionCanceledInAppNotificationEnabled = notificationPreferences.auctionCanceledInAppNotificationEnabled
        account.englishAuctionSettledInAppNotificationEnabled =
        ...
        account.nftSellOrderMadeInAppNotificationEnabled = notificationPreferences.nftSellOrderMadeInAppNotificationEnabled
        account.nftBoughtInAppNotificationEnabled = notificationPreferences.nftBoughtInAppNotificationEnabled
        account.buyNowCanceledInAppNotificationEnabled = notificationPreferences.buyNowCanceledInAppNotificationEnabled
        account.buyNowPriceUpdatedInAppNotificationEnabled =
        ...
        account.channelCreatedInAppNotificationEnabled = notificationPreferences.channelCreatedInAppNotificationEnabled
        account.commentCreatedMailNotificationEnabled = notificationPreferences.commentCreatedMailNotificationEnabled
        ...
        account.nftIssuedMailNotificationEnabled = notificationPreferences.nftIssuedMailNotificationEnabled
        account.auctionBidMadeMailNotificationEnabled = notificationPreferences.auctionBidMadeMailNotificationEnabled
        account.auctionBidCanceledMailNotificationEnabled =
          notificationPreferences.auctionBidCanceledMailNotificationEnabled
        account.auctionCanceledMailNotificationEnabled = notificationPreferences.auctionCanceledMailNotificationEnabled
        account.englishAuctionSettledMailNotificationEnabled =
        ...
        account.nftSellOrderMadeMailNotificationEnabled = notificationPreferences.nftSellOrderMadeMailNotificationEnabled
        account.nftBoughtMailNotificationEnabled = notificationPreferences.nftBoughtMailNotificationEnabled
        account.buyNowCanceledMailNotificationEnabled = notificationPreferences.buyNowCanceledMailNotificationEnabled
        account.buyNowPriceUpdatedMailNotificationEnabled =
        ...
        account.channelCreatedMailNotificationEnabled = notificationPreferences.channelCreatedMailNotificationEnabled
