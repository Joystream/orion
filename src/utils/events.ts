...
export const eventConstructors = {
  ...
  "ProjectToken.PatronageRateDecreasedTo":
    ProjectTokenPatronageRateDecreasedToEvent,
  "ProjectToken.PatronageCreditClaimed":
    ProjectTokenPatronageCreditClaimedEvent,
  ...
  "ProjectToken.TokenAmountTransferred":
    ProjectTokenTokenAmountTransferredEvent,
  ...
  "ProjectToken.UserParticipatedInSplit":
    ProjectTokenUserParticipatedInSplitEvent,
...
export type EventConstructor<EventName extends EventNames> =
  typeof eventConstructors[EventName];
export type EventInstance<EventName extends EventNames> = InstanceType<
  EventConstructor<EventName>
>;
