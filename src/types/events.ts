...
export class ContentAuctionBidMadeEvent {
    ...
    get asV2000(): [bigint, bigint, bigint, (bigint | undefined)] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentAuctionCanceledEvent {
    ...
    get asV2000(): [v2000.ContentActor, bigint] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentBidMadeCompletingAuctionEvent {
    ...
    get asV2000(): [bigint, bigint, (bigint | undefined)] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentBuyNowCanceledEvent {
    ...
    get asV2000(): [bigint, v2000.ContentActor] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentBuyNowPriceUpdatedEvent {
    ...
    get asV2000(): [bigint, v2000.ContentActor, bigint] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentChannelAgentRemarkedEvent {
    ...
    get asV2000(): [v2000.ContentActor, bigint, Uint8Array] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentChannelCreatedEvent {
    ...
    get asV2000(): [bigint, v2000.ChannelRecord, v2000.ChannelCreationParametersRecord, Uint8Array] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentChannelFundsWithdrawnEvent {
    ...
    get asV2000(): [v2000.ContentActor, bigint, bigint, v2000.ChannelFundsDestination] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentChannelPayoutsUpdatedEvent {
    ...
    get asV2000(): [v2000.UpdateChannelPayoutsParametersRecord, (bigint | undefined)] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentChannelRewardUpdatedEvent {
    ...
    get asV2000(): [bigint, bigint, bigint] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentChannelUpdatedEvent {
    ...
    get asV2000(): [v2000.ContentActor, bigint, v2000.ChannelUpdateParametersRecord, bigint[]] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentChannelVisibilitySetByModeratorEvent {
    ...
    get asV2000(): [v2000.ContentActor, bigint, boolean, Uint8Array] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentEnglishAuctionSettledEvent {
    ...
    get asV2000(): [bigint, Uint8Array, bigint] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentEnglishAuctionStartedEvent {
    ...
    get asV2000(): [v2000.ContentActor, bigint, v2000.EnglishAuctionParamsRecord] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentNftIssuedEvent {
    ...
    get asV2000(): [v2000.ContentActor, bigint, v2000.NftIssuanceParametersRecord] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentOfferStartedEvent {
    ...
    get asV2000(): [bigint, v2000.ContentActor, bigint, (bigint | undefined)] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentOpenAuctionBidAcceptedEvent {
    ...
    get asV2000(): [v2000.ContentActor, bigint, bigint, bigint] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentOpenAuctionStartedEvent {
    ...
    get asV2000(): [v2000.ContentActor, bigint, v2000.OpenAuctionParamsRecord, bigint] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentVideoCreatedEvent {
    ...
    get asV2000(): [v2000.ContentActor, bigint, bigint, v2000.VideoCreationParametersRecord, bigint[]] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentVideoUpdatedEvent {
    ...
    get asV2000(): [v2000.ContentActor, bigint, v2000.VideoUpdateParametersRecord, bigint[]] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MembersMemberAccountsUpdatedEvent {
    ...
    get asV2000(): [bigint, (Uint8Array | undefined), (Uint8Array | undefined)] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MembersMemberCreatedEvent {
    ...
    get asV2000(): [bigint, v2000.CreateMemberParameters, number] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MembersMemberInvitedEvent {
    ...
    get asV2000(): [bigint, v2000.InviteMembershipParameters] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MembersMemberRemarkedEvent {
    ...
    get asV2000(): [bigint, Uint8Array, ([Uint8Array, bigint] | undefined)] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MembersMembershipBoughtEvent {
    ...
    get asV2000(): [bigint, v2000.BuyMembershipParameters, number] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MembersMembershipGiftedEvent {
    ...
    get asV2000(): [bigint, v2000.GiftMembershipParameters] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageDataObjectsDeletedEvent {
     ...
     */
    get isV2000(): boolean {
        return this._chain.getEventHash('Storage.DataObjectsDeleted') === '4d88084b7463c1925d3436f8e05f7e4710a8f0491077d7024763d3ad3739f06f'
    }
     ...
     * - data object IDs
     */
    get asV2000(): [Uint8Array, v2000.BagIdType, bigint[]] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageDataObjectsMovedEvent {
     ...
     */
    get isV2000(): boolean {
        return this._chain.getEventHash('Storage.DataObjectsMoved') === '5f23f0283138b2fa4d4645c051eea50aab5b96b9da1abcc33b698f77b5775c44'
    }
     ...
     * - data object IDs
     */
    get asV2000(): [v2000.BagIdType, v2000.BagIdType, bigint[]] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageDataObjectsUpdatedEvent {
     ...
     */
    get isV2000(): boolean {
        return this._chain.getEventHash('Storage.DataObjectsUpdated') === '09c8ee90a86fe74594bc9f0dbb87411fe1945fcc54dbd14d3607999396fecd6a'
    }
     ...
     * - Ids of the removed objects
     */
    get asV2000(): [v2000.UploadParametersRecord, bigint[], bigint[]] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageDataObjectsUploadedEvent {
     ...
     */
    get isV2000(): boolean {
        return this._chain.getEventHash('Storage.DataObjectsUploaded') === 'f6173f7846e245861839ccc3b832908dd589c5a9ef5b02ea81abb4d9efcc6b74'
    }
     ...
     * - state bloat bond for objects
     */
    get asV2000(): [bigint[], v2000.UploadParametersRecord, bigint] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageDistributionBucketCreatedEvent {
     ...
     * - distribution bucket ID
     */
    get asV2000(): [bigint, boolean, v2000.DistributionBucketIdRecord] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageDistributionBucketDeletedEvent {
     ...
     * - distribution bucket ID
     */
    get asV2000(): v2000.DistributionBucketIdRecord {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageDistributionBucketInvitationAcceptedEvent {
     ...
     * - distribution bucket ID
     */
    get asV2000(): [bigint, v2000.DistributionBucketIdRecord] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageDistributionBucketInvitationCancelledEvent {
     ...
     * - operator worker ID
     */
    get asV2000(): [v2000.DistributionBucketIdRecord, bigint] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageDistributionBucketMetadataSetEvent {
     ...
     * - metadata
     */
    get asV2000(): [bigint, v2000.DistributionBucketIdRecord, Uint8Array] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageDistributionBucketModeUpdatedEvent {
     ...
     * - distributing
     */
    get asV2000(): [v2000.DistributionBucketIdRecord, boolean] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageDistributionBucketsUpdatedForBagEvent {
     ...
     */
    get isV2000(): boolean {
        return this._chain.getEventHash('Storage.DistributionBucketsUpdatedForBag') === 'fd0484bd49fb211c51ce811322577df60e9929527e06e86d286c5ef1e42fc9ee'
    }
     ...
     * - storage buckets to remove ID collection
     */
    get asV2000(): [v2000.BagIdType, bigint, bigint[], bigint[]] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageDynamicBagCreatedEvent {
     ...
     * - uploaded data objects ids
     */
    get asV2000(): [v2000.DynBagCreationParametersRecord, bigint[]] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageDynamicBagDeletedEvent {
     ...
     * - dynamic bag ID
     */
    get asV2000(): v2000.DynamicBagIdType {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StoragePendingDataObjectsAcceptedEvent {
     ...
     */
    get isV2000(): boolean {
        return this._chain.getEventHash('Storage.PendingDataObjectsAccepted') === 'b7a5c6086068a5bb3d39e5bc19aa8fed1bfdd70f06e7b4757eeef89a011ce58e'
    }
     ...
     * - pending data objects
     */
    get asV2000(): [bigint, bigint, v2000.BagIdType, bigint[]] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageStorageBucketCreatedEvent {
     ...
     * - objects limit for voucher,
     */
    get asV2000(): [bigint, (bigint | undefined), boolean, bigint, bigint] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageStorageBucketInvitationAcceptedEvent {
     ...
     * - transactor account ID
     */
    get asV2000(): [bigint, bigint, Uint8Array] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageStorageBucketsUpdatedForBagEvent {
     ...
     */
    get isV2000(): boolean {
        return this._chain.getEventHash('Storage.StorageBucketsUpdatedForBag') === '598912ba505d559ca0ddf506d04aae89adc667318363e563afd3968a2ff1a6c9'
    }
     ...
     * - storage buckets to remove ID collection
     */
    get asV2000(): [v2000.BagIdType, bigint[], bigint[]] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageVoucherChangedEvent {
     ...
     * - new voucher
     */
    get asV2000(): [bigint, v2000.Voucher] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
}
