...
export async function processOpenAuctionStartedEvent({
  ...
  extrinsicHash,
  event: {
    asV2001: [contentActor, videoId, auctionParams],
  },
...
export async function processNftIssuedEvent({
  ...
  extrinsicHash,
  event: {
    asV2001: [actor, videoId, nftIssuanceParameters],
  },
...
export async function processAuctionBidMadeEvent({
  ...
  extrinsicHash,
  event: {
    asV2001: [memberId, videoId, bidAmount],
  },
...
export async function processOpenAuctionBidAcceptedEvent({
  ...
  extrinsicHash,
  event: {
    asV2001: [contentActor, videoId, winnerId, bidAmount],
  },
...
export async function processOfferStartedEvent({
  overlay,
  event: {
    asV2001: [videoId, , memberId, price],
  },
...
export async function processNftSellOrderMadeEvent({
  ...
  extrinsicHash,
  event: {
    asV2001: [videoId, contentActor, price],
  },
...
export async function processBuyNowPriceUpdatedEvent({
  ...
  extrinsicHash,
  event: {
    asV2001: [videoId, contentActor, newPrice],
  },
