...
} from '../../server-extension/resolvers/NotificationResolver/types'
...
export async function executeSubcription<T>(
  client: ApolloClient<NormalizedCacheObject>,
  { query, variables, shouldUnsuscribe }: SubscriptionSession<T>
) {
...
export const ChannelFollowerNotificationSub = gql`
  subscription ChannelFollowerNotification($channelId: String!) {
    offChainNotifications(
      where: {
        data: { channel: { id_eq: $channelId }, isTypeOf_eq: "NewChannelFollowerNotificationData" }
      }
    ) {
      id
      mailSent
  ...
  mutation {
    setAccountNotificationPreferences(
      notificationPreferences: {
        channelExcludedFromAppNotificationEnabled: { inAppEnabled: false, emailEnabled: false }
        videoExcludedFromAppNotificationEnabled: { inAppEnabled: false, emailEnabled: false }
        videoFeaturedAsHeroNotificationEnabled: { inAppEnabled: false, emailEnabled: false }
        videoFeaturedOnCategoryPageNotificationEnabled: { inAppEnabled: false, emailEnabled: false }
        nftFeaturedOnMarketPlaceNotificationEnabled: { inAppEnabled: false, emailEnabled: false }
        newChannelFollowerNotificationEnabled: { inAppEnabled: false, emailEnabled: false }
        videoCommentCreatedNotificationEnabled: { inAppEnabled: false, emailEnabled: false }
        videoLikedNotificationEnabled: { inAppEnabled: false, emailEnabled: false }
        videoDislikedNotificationEnabled: { inAppEnabled: false, emailEnabled: false }
        yppSignupSuccessfulNotificationEnabled: { inAppEnabled: false, emailEnabled: false }
        yppChannelVerifiedNotificationEnabled: { inAppEnabled: false, emailEnabled: false }
        nftBoughtNotificationEnabled: { inAppEnabled: false, emailEnabled: false }
        bidMadeOnNftNotificationEnabled: { inAppEnabled: false, emailEnabled: false }
        royaltyReceivedNotificationEnabled: { inAppEnabled: false, emailEnabled: false }
        channelPaymentReceivedNotificationEnabled: { inAppEnabled: false, emailEnabled: false }
        channelReceivedFundsFromWgNotificationEnabled: { inAppEnabled: false, emailEnabled: false }
        newPayoutUpdatedByCouncilNotificationEnabled: { inAppEnabled: false, emailEnabled: false }
        channelFundsWithdrawnNotificationEnabled: { inAppEnabled: false, emailEnabled: false }
        channelCreatedNotificationEnabled: { inAppEnabled: false, emailEnabled: false }
        replyToCommentNotificationEnabled: { inAppEnabled: false, emailEnabled: false }
        reactionToCommentNotificationEnabled: { inAppEnabled: false, emailEnabled: false }
        videoPostedNotificationEnabled: { emailEnabled: false, inAppEnabled: false }
        newNftOnAuctionNotificationEnabled: { inAppEnabled: false, emailEnabled: false }
        newNftOnSaleNotificationEnabled: { inAppEnabled: false, emailEnabled: false }
        higherBidThanYoursMadeNotificationEnabled: { inAppEnabled: false, emailEnabled: false }
        auctionExpiredNotificationEnabled: { inAppEnabled: false, emailEnabled: false }
        auctionWonNotificationEnabled: { inAppEnabled: false, emailEnabled: false }
        auctionLostNotificationEnabled: { inAppEnabled: false, emailEnabled: false }
        openAuctionBidCanBeWithdrawnNotificationEnabled: {
          inAppEnabled: false
          emailEnabled: false
        }
        fundsFromCouncilReceivedNotificationEnabled: { inAppEnabled: false, emailEnabled: false }
        fundsToExternalWalletSentNotificationEnabled: { inAppEnabled: false, emailEnabled: false }
        fundsFromWgReceivedNotificationEnabled: { inAppEnabled: false, emailEnabled: false }
      }
    ) {
...
export function expectNotificationPreferenceToBe(
  pref: NotificationPreference | NotificationPreferenceGQL,
  expected: boolean
) {
...
export function checkAllNotificationPreferencesToBe(
  preferences: AccountNotificationPreferencesOutput | AccountNotificationPreferences,
  expected: boolean
) {
