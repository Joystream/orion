...
export class OpenAuctionStartedEventData {
    public readonly isTypeOf = 'OpenAuctionStartedEventData'
    private _actor!: ContentActor
    private _nftOwner!: NftOwner
    private _auction!: string

    constructor(props?: Partial<Omit<OpenAuctionStartedEventData, 'toJSON'>>, json?: any) {
