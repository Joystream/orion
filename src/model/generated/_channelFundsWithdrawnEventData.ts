...
export class ChannelFundsWithdrawnEventData {
    public readonly isTypeOf = 'ChannelFundsWithdrawnEventData'
    private _channel!: string
    private _amount!: bigint
    private _account!: string | undefined | null
    private _actor!: ContentActor

    constructor(props?: Partial<Omit<ChannelFundsWithdrawnEventData, 'toJSON'>>, json?: any) {
