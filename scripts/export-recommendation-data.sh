...
VIDEO_SELECT_QUERY="SELECT id as \"itemId\", category_id, channel_id, title, language, duration, comments_count, EXTRACT(EPOCH FROM created_at) as timestamp, reactions_count, views_num FROM admin.video"
